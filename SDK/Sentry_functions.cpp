...
class USentrySpan* USentryTransaction::StartChildWithTimestamp(const class FString& Operation, const class FString& Description, int64 Timestamp)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SentryTransaction", "StartChildWithTimestamp");

	Params::SentryTransaction_StartChildWithTimestamp Parms{};
