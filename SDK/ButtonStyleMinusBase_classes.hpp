...
static_assert(alignof(UButtonStyleMinusBase_C) == 0x000010, "Wrong alignment on UButtonStyleMinusBase_C");
static_assert(sizeof(UButtonStyleMinusBase_C) == 0x0007B0, "Wrong size on UButtonStyleMinusBase_C");
