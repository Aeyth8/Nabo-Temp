...
static_assert(sizeof(SentrySpan_StartChild) == 0x000028, "Wrong size on SentrySpan_StartChild");
...
static_assert(offsetof(SentrySpan_StartChild, ReturnValue) == 0x000020, "Member 'SentrySpan_StartChild::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SentrySpan_StartChildWithTimestamp) == 0x000030, "Wrong size on SentrySpan_StartChildWithTimestamp");
...
static_assert(offsetof(SentrySpan_StartChildWithTimestamp, ReturnValue) == 0x000028, "Member 'SentrySpan_StartChildWithTimestamp::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SentrySubsystem_StartTransactionWithContextAndTimestamp) == 0x000018, "Wrong size on SentrySubsystem_StartTransactionWithContextAndTimestamp");
...
static_assert(offsetof(SentrySubsystem_StartTransactionWithContextAndTimestamp, ReturnValue) == 0x000010, "Member 'SentrySubsystem_StartTransactionWithContextAndTimestamp::ReturnValue' has a wrong offset!");
...
// Function Sentry.SentryTransaction.StartChildWithTimestamp
// 0x0030 (0x0030 - 0x0000)
struct SentryTransaction_StartChildWithTimestamp final
{
public:
	class FString                                 Operation;                                         // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Description;                                       // 0x0010(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(SentryTransaction_StartChildWithTimestamp) == 0x000008, "Wrong alignment on SentryTransaction_StartChildWithTimestamp");
static_assert(sizeof(SentryTransaction_StartChildWithTimestamp) == 0x000030, "Wrong size on SentryTransaction_StartChildWithTimestamp");
static_assert(offsetof(SentryTransaction_StartChildWithTimestamp, Operation) == 0x000000, "Member 'SentryTransaction_StartChildWithTimestamp::Operation' has a wrong offset!");
static_assert(offsetof(SentryTransaction_StartChildWithTimestamp, Description) == 0x000010, "Member 'SentryTransaction_StartChildWithTimestamp::Description' has a wrong offset!");
static_assert(offsetof(SentryTransaction_StartChildWithTimestamp, Timestamp) == 0x000020, "Member 'SentryTransaction_StartChildWithTimestamp::Timestamp' has a wrong offset!");
static_assert(offsetof(SentryTransaction_StartChildWithTimestamp, ReturnValue) == 0x000028, "Member 'SentryTransaction_StartChildWithTimestamp::ReturnValue' has a wrong offset!");
