...
#include "TT_SameTeam_classes.hpp"
#include "TT_SameTeam_parameters.hpp"
...
bool UTT_SameTeam_C::ShouldFilterTargetBP(const class AActor* HitActor, const class AActor* Source) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TT_SameTeam_C", "ShouldFilterTargetBP");

	Params::TT_SameTeam_C_ShouldFilterTargetBP Parms{};
