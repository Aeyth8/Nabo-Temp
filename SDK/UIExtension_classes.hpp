...
{
public:
	struct FGameplayTag                           ExtensionPointTag;                                 // 0x0258(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EUIExtensionPointMatch                        ExtensionPointTagMatch;                            // 0x0260(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UObject>>            DataClasses;                                       // 0x0268(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TDelegate<void(class UObject* DataItem)>      GetWidgetClassForData;                             // 0x0278(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TDelegate<void(class UUserWidget* Widget, class UObject* DataItem)> ConfigureWidgetForData;                            // 0x0288(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_298[0x10];                                     // 0x0298(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FUIExtensionHandle, class UUserWidget*> ExtensionMapping;                                  // 0x02A8(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)

public:
	void OnConfigureWidgetForData__DelegateSignature(class UUserWidget* Widget, class UObject* DataItem);
	TSubclassOf<class UUserWidget> OnGetWidgetClassForData__DelegateSignature(class UObject* DataItem);
...
static_assert(sizeof(UUIExtensionPointWidget) == 0x0002F8, "Wrong size on UUIExtensionPointWidget");
static_assert(offsetof(UUIExtensionPointWidget, ExtensionPointTag) == 0x000258, "Member 'UUIExtensionPointWidget::ExtensionPointTag' has a wrong offset!");
static_assert(offsetof(UUIExtensionPointWidget, ExtensionPointTagMatch) == 0x000260, "Member 'UUIExtensionPointWidget::ExtensionPointTagMatch' has a wrong offset!");
static_assert(offsetof(UUIExtensionPointWidget, DataClasses) == 0x000268, "Member 'UUIExtensionPointWidget::DataClasses' has a wrong offset!");
static_assert(offsetof(UUIExtensionPointWidget, GetWidgetClassForData) == 0x000278, "Member 'UUIExtensionPointWidget::GetWidgetClassForData' has a wrong offset!");
static_assert(offsetof(UUIExtensionPointWidget, ConfigureWidgetForData) == 0x000288, "Member 'UUIExtensionPointWidget::ConfigureWidgetForData' has a wrong offset!");
static_assert(offsetof(UUIExtensionPointWidget, ExtensionMapping) == 0x0002A8, "Member 'UUIExtensionPointWidget::ExtensionMapping' has a wrong offset!");
