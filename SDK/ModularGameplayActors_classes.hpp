...
static_assert(sizeof(AModularGameModeBase) == 0x000328, "Wrong size on AModularGameModeBase");
...
static_assert(sizeof(AModularGameMode) == 0x000370, "Wrong size on AModularGameMode");
...
static_assert(sizeof(AModularPlayerController) == 0x000858, "Wrong size on AModularPlayerController");
...
static_assert(sizeof(AModularPlayerState) == 0x000348, "Wrong size on AModularPlayerState");
