...
// Function GameSettings.GameSettingListEntrySetting_Scalar.GetNormalizedStep
// 0x0004 (0x0004 - 0x0000)
struct GameSettingListEntrySetting_Scalar_GetNormalizedStep final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GameSettingListEntrySetting_Scalar_GetNormalizedStep) == 0x000004, "Wrong alignment on GameSettingListEntrySetting_Scalar_GetNormalizedStep");
static_assert(sizeof(GameSettingListEntrySetting_Scalar_GetNormalizedStep) == 0x000004, "Wrong size on GameSettingListEntrySetting_Scalar_GetNormalizedStep");
static_assert(offsetof(GameSettingListEntrySetting_Scalar_GetNormalizedStep, ReturnValue) == 0x000000, "Member 'GameSettingListEntrySetting_Scalar_GetNormalizedStep::ReturnValue' has a wrong offset!");
