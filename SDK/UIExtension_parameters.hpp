...
static_assert(alignof(UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature) == 0x000008, "Wrong alignment on UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature");
static_assert(sizeof(UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature) == 0x000010, "Wrong size on UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature");
static_assert(offsetof(UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature, Widget) == 0x000000, "Member 'UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature::Widget' has a wrong offset!");
static_assert(offsetof(UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature, DataItem) == 0x000008, "Member 'UIExtensionPointWidget_OnConfigureWidgetForData__DelegateSignature::DataItem' has a wrong offset!");
...
static_assert(alignof(UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature) == 0x000008, "Wrong alignment on UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature");
static_assert(sizeof(UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature) == 0x000010, "Wrong size on UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature");
static_assert(offsetof(UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature, DataItem) == 0x000000, "Member 'UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature::DataItem' has a wrong offset!");
static_assert(offsetof(UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature, ReturnValue) == 0x000008, "Member 'UIExtensionPointWidget_OnGetWidgetClassForData__DelegateSignature::ReturnValue' has a wrong offset!");
