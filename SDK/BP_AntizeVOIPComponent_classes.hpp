...
public:
	...
	class USoundAttenuation* GetAttenutation(bool InMyTeam, bool IsMuted__0);
...
static_assert(sizeof(UBP_AntizeVOIPComponent_C) == 0x0000F0, "Wrong size on UBP_AntizeVOIPComponent_C");
