...
void UUMG_RadialMenu_C::GetChild(int32 Index_0, class UUserWidget** Output, bool* Success)
{
	static class UFunction* Func = nullptr;
...
void UUMG_RadialMenu_C::GetCurrentIndex(int32* Index_0, bool* Valid)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FVector2D                        LookStickValue1                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector2D                        LookStickValue                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    JoystickIsBeingUsed                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUMG_RadialMenu_C::IsJoystickBeingUsed(const struct FVector2D& LookStickValue1, struct FVector2D* LookStickValue, bool* JoystickIsBeingUsed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UMG_RadialMenu_C", "IsJoystickBeingUsed");

	Params::UMG_RadialMenu_C_IsJoystickBeingUsed Parms{};

	Parms.LookStickValue1 = std::move(LookStickValue1);

	UObject::ProcessEvent(Func, &Parms);

	if (LookStickValue != nullptr)
		*LookStickValue = std::move(Parms.LookStickValue);

	if (JoystickIsBeingUsed != nullptr)
		*JoystickIsBeingUsed = Parms.JoystickIsBeingUsed;
}
...
void UUMG_RadialMenu_C::SetIndex(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void UUMG_RadialMenu_C::Update_Direction_With_Joystick()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UMG_RadialMenu_C", "Update Direction With Joystick");
...
void UUMG_RadialMenu_C::UpdateChildPosition(int32 Index_0)
{
	static class UFunction* Func = nullptr;
