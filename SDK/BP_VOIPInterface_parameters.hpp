...
public:
	...
	class FText                                   Username;                                          // 0x0008(0x0010)(Parm, OutParm)
};
...
static_assert(sizeof(BP_VOIPInterface_C_MSG_AVP_GetPlayerUsername) == 0x000018, "Wrong size on BP_VOIPInterface_C_MSG_AVP_GetPlayerUsername");
