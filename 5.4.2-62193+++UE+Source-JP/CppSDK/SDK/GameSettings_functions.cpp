...
float UGameSettingListEntrySetting_Scalar::GetNormalizedStep() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameSettingListEntrySetting_Scalar", "GetNormalizedStep");

	Params::GameSettingListEntrySetting_Scalar_GetNormalizedStep Parms{};
