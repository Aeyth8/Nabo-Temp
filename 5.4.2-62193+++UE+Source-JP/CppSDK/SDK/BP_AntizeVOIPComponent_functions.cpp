...
// bool                                    IsMuted__0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class USoundAttenuation*                ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash)

class USoundAttenuation* UBP_AntizeVOIPComponent_C::GetAttenutation(bool InMyTeam, bool IsMuted__0)
{
	static class UFunction* Func = nullptr;
...
void UBP_AntizeVOIPComponent_C::Server_SetTeamID(int32 TeamId_0)
{
	static class UFunction* Func = nullptr;
