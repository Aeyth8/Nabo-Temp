...
public:
	...
	bool                                          AttachGpuDump;                                     // 0x0060(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxBreadcrumbs;                                    // 0x0064(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAutomaticBreadcrumbs                  AutomaticBreadcrumbs;                              // 0x0068(0x0005)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FAutomaticBreadcrumbsForLogs           AutomaticBreadcrumbsForLogs;                       // 0x006D(0x0005)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          EnableAutoSessionTracking;                         // 0x0072(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          EnableAutoCrashCapturing;                          // 0x00B0(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryDatabaseLocation                       DatabaseLocation;                                  // 0x00B1(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B2[0x6];                                       // 0x00B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         InAppInclude;                                      // 0x00B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                         InAppExclude;                                      // 0x00C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          EnableAppNotRespondingTracking;                    // 0x00D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableTracing;                                     // 0x00D9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryTracesSamplingType                     SamplingType;                                      // 0x00DA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_DB[0x1];                                       // 0x00DB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TracesSampleRate;                                  // 0x00DC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class USentryTraceSampler>        TracesSampler;                                     // 0x00E0(0x0008)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTagsPromotion                         TagsPromotion;                                     // 0x00E8(0x0006)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FEnableBuildConfigurations             EnableBuildConfigurations;                         // 0x00EE(0x0005)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FEnableBuildTargets                    EnableBuildTargets;                                // 0x00F3(0x0005)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FEnableBuildPlatforms                  EnableBuildPlatforms;                              // 0x00F8(0x0005)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          EnableForPromotedBuildsOnly;                       // 0x00FD(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UploadSymbolsAutomatically;                        // 0x00FE(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_FF[0x1];                                       // 0x00FF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ProjectName;                                       // 0x0100(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OrgName;                                           // 0x0110(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AuthToken;                                         // 0x0120(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IncludeSources;                                    // 0x0130(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryCliLogLevel                            DiagnosticLevel;                                   // 0x0131(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseLegacyGradlePlugin;                             // 0x0132(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_133[0x5];                                      // 0x0133(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CrashReporterUrl;                                  // 0x0138(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USentrySettings) == 0x000150, "Wrong size on USentrySettings");
...
static_assert(offsetof(USentrySettings, AttachGpuDump) == 0x000060, "Member 'USentrySettings::AttachGpuDump' has a wrong offset!");
static_assert(offsetof(USentrySettings, MaxBreadcrumbs) == 0x000064, "Member 'USentrySettings::MaxBreadcrumbs' has a wrong offset!");
static_assert(offsetof(USentrySettings, AutomaticBreadcrumbs) == 0x000068, "Member 'USentrySettings::AutomaticBreadcrumbs' has a wrong offset!");
static_assert(offsetof(USentrySettings, AutomaticBreadcrumbsForLogs) == 0x00006D, "Member 'USentrySettings::AutomaticBreadcrumbsForLogs' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableAutoSessionTracking) == 0x000072, "Member 'USentrySettings::EnableAutoSessionTracking' has a wrong offset!");
static_assert(offsetof(USentrySettings, SessionTimeout) == 0x000074, "Member 'USentrySettings::SessionTimeout' has a wrong offset!");
static_assert(offsetof(USentrySettings, OverrideReleaseName) == 0x000078, "Member 'USentrySettings::OverrideReleaseName' has a wrong offset!");
static_assert(offsetof(USentrySettings, Release) == 0x000080, "Member 'USentrySettings::Release' has a wrong offset!");
static_assert(offsetof(USentrySettings, UseProxy) == 0x000090, "Member 'USentrySettings::UseProxy' has a wrong offset!");
static_assert(offsetof(USentrySettings, ProxyUrl) == 0x000098, "Member 'USentrySettings::ProxyUrl' has a wrong offset!");
static_assert(offsetof(USentrySettings, BeforeSendHandler) == 0x0000A8, "Member 'USentrySettings::BeforeSendHandler' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableAutoCrashCapturing) == 0x0000B0, "Member 'USentrySettings::EnableAutoCrashCapturing' has a wrong offset!");
static_assert(offsetof(USentrySettings, DatabaseLocation) == 0x0000B1, "Member 'USentrySettings::DatabaseLocation' has a wrong offset!");
static_assert(offsetof(USentrySettings, InAppInclude) == 0x0000B8, "Member 'USentrySettings::InAppInclude' has a wrong offset!");
static_assert(offsetof(USentrySettings, InAppExclude) == 0x0000C8, "Member 'USentrySettings::InAppExclude' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableAppNotRespondingTracking) == 0x0000D8, "Member 'USentrySettings::EnableAppNotRespondingTracking' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableTracing) == 0x0000D9, "Member 'USentrySettings::EnableTracing' has a wrong offset!");
static_assert(offsetof(USentrySettings, SamplingType) == 0x0000DA, "Member 'USentrySettings::SamplingType' has a wrong offset!");
static_assert(offsetof(USentrySettings, TracesSampleRate) == 0x0000DC, "Member 'USentrySettings::TracesSampleRate' has a wrong offset!");
static_assert(offsetof(USentrySettings, TracesSampler) == 0x0000E0, "Member 'USentrySettings::TracesSampler' has a wrong offset!");
static_assert(offsetof(USentrySettings, TagsPromotion) == 0x0000E8, "Member 'USentrySettings::TagsPromotion' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildConfigurations) == 0x0000EE, "Member 'USentrySettings::EnableBuildConfigurations' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildTargets) == 0x0000F3, "Member 'USentrySettings::EnableBuildTargets' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableBuildPlatforms) == 0x0000F8, "Member 'USentrySettings::EnableBuildPlatforms' has a wrong offset!");
static_assert(offsetof(USentrySettings, EnableForPromotedBuildsOnly) == 0x0000FD, "Member 'USentrySettings::EnableForPromotedBuildsOnly' has a wrong offset!");
static_assert(offsetof(USentrySettings, UploadSymbolsAutomatically) == 0x0000FE, "Member 'USentrySettings::UploadSymbolsAutomatically' has a wrong offset!");
static_assert(offsetof(USentrySettings, ProjectName) == 0x000100, "Member 'USentrySettings::ProjectName' has a wrong offset!");
static_assert(offsetof(USentrySettings, OrgName) == 0x000110, "Member 'USentrySettings::OrgName' has a wrong offset!");
static_assert(offsetof(USentrySettings, AuthToken) == 0x000120, "Member 'USentrySettings::AuthToken' has a wrong offset!");
static_assert(offsetof(USentrySettings, IncludeSources) == 0x000130, "Member 'USentrySettings::IncludeSources' has a wrong offset!");
static_assert(offsetof(USentrySettings, DiagnosticLevel) == 0x000131, "Member 'USentrySettings::DiagnosticLevel' has a wrong offset!");
static_assert(offsetof(USentrySettings, UseLegacyGradlePlugin) == 0x000132, "Member 'USentrySettings::UseLegacyGradlePlugin' has a wrong offset!");
static_assert(offsetof(USentrySettings, CrashReporterUrl) == 0x000138, "Member 'USentrySettings::CrashReporterUrl' has a wrong offset!");
