...
// Class IWGamepadCursor.GamepadCursorFunctionLibrary
// 0x0000 (0x0028 - 0x0028)
class UGamepadCursorFunctionLibrary final : public UBlueprintFunctionLibrary
{
public:
...
public:
	...
	{
		return StaticClassImpl<"GamepadCursorFunctionLibrary">();
	}
	static class UGamepadCursorFunctionLibrary* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGamepadCursorFunctionLibrary>();
	}
};
static_assert(alignof(UGamepadCursorFunctionLibrary) == 0x000008, "Wrong alignment on UGamepadCursorFunctionLibrary");
static_assert(sizeof(UGamepadCursorFunctionLibrary) == 0x000028, "Wrong size on UGamepadCursorFunctionLibrary");

// Class IWGamepadCursor.GamepadCursorSettings
