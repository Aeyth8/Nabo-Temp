...
class ABP_Window_C : public AHouseActorBase_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Window_C;                        // 0x03F0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	bool                                          LockedToPlayer;                                    // 0x04D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4D2[0x6];                                      // 0x04D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           DisableWindowSkeleTickTimer_0;                     // 0x04D8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             InteractedWith;                                    // 0x04E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(ABP_Window_C) == 0x0004F0, "Wrong size on ABP_Window_C");
static_assert(offsetof(ABP_Window_C, UberGraphFrame_BP_Window_C) == 0x0003F0, "Member 'ABP_Window_C::UberGraphFrame_BP_Window_C' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, BP_PingableComponent) == 0x0003F8, "Member 'ABP_Window_C::BP_PingableComponent' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, AC_DefenceUpgrade) == 0x000400, "Member 'ABP_Window_C::AC_DefenceUpgrade' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, SceneDestroyed) == 0x000408, "Member 'ABP_Window_C::SceneDestroyed' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, FrameBroken) == 0x000410, "Member 'ABP_Window_C::FrameBroken' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, SK_Windows_B_Broken) == 0x000418, "Member 'ABP_Window_C::SK_Windows_B_Broken' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, SkeletalMeshOK) == 0x000420, "Member 'ABP_Window_C::SkeletalMeshOK' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, AudioOpenClose) == 0x000428, "Member 'ABP_Window_C::AudioOpenClose' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, Arrow) == 0x000430, "Member 'ABP_Window_C::Arrow' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, BoxPrimaryBlocker) == 0x000438, "Member 'ABP_Window_C::BoxPrimaryBlocker' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, BoxInteract) == 0x000440, "Member 'ABP_Window_C::BoxInteract' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, GroundskeeperReference1) == 0x000448, "Member 'ABP_Window_C::GroundskeeperReference1' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, FrameOK) == 0x000450, "Member 'ABP_Window_C::FrameOK' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, SceneBroken) == 0x000458, "Member 'ABP_Window_C::SceneBroken' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, SceneOK) == 0x000460, "Member 'ABP_Window_C::SceneOK' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, Opened) == 0x000468, "Member 'ABP_Window_C::Opened' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, CharacterIsInFront) == 0x000469, "Member 'ABP_Window_C::CharacterIsInFront' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, WindowOpenInwards) == 0x00046A, "Member 'ABP_Window_C::WindowOpenInwards' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, GlassHitMaterials) == 0x000470, "Member 'ABP_Window_C::GlassHitMaterials' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, GlassHits) == 0x000480, "Member 'ABP_Window_C::GlassHits' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, ShatteredGeometry) == 0x000490, "Member 'ABP_Window_C::ShatteredGeometry' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, Last_Impulse) == 0x0004A0, "Member 'ABP_Window_C::Last_Impulse' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, LockedSound) == 0x0004B8, "Member 'ABP_Window_C::LockedSound' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, AudioMultiplierApplied) == 0x0004C0, "Member 'ABP_Window_C::AudioMultiplierApplied' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, LastDamageCauser) == 0x0004C8, "Member 'ABP_Window_C::LastDamageCauser' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, AutoClose) == 0x0004D0, "Member 'ABP_Window_C::AutoClose' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, LockedToPlayer) == 0x0004D1, "Member 'ABP_Window_C::LockedToPlayer' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, DisableWindowSkeleTickTimer_0) == 0x0004D8, "Member 'ABP_Window_C::DisableWindowSkeleTickTimer_0' has a wrong offset!");
static_assert(offsetof(ABP_Window_C, InteractedWith) == 0x0004E0, "Member 'ABP_Window_C::InteractedWith' has a wrong offset!");
