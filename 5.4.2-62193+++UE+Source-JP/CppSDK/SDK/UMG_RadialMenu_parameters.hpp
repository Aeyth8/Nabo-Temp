...
static_assert(sizeof(UMG_RadialMenu_C_DebugIndex) == 0x0000C8, "Wrong size on UMG_RadialMenu_C_DebugIndex");
...
static_assert(offsetof(UMG_RadialMenu_C_DebugIndex, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000010, "Member 'UMG_RadialMenu_C_DebugIndex::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_DebugIndex, K2Node_MakeStruct_FormatArgumentData_1) == 0x000060, "Member 'UMG_RadialMenu_C_DebugIndex::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_DebugIndex, K2Node_MakeArray_Array) == 0x0000A8, "Member 'UMG_RadialMenu_C_DebugIndex::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_DebugIndex, CallFunc_Format_ReturnValue) == 0x0000B8, "Member 'UMG_RadialMenu_C_DebugIndex::CallFunc_Format_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_GetChild, Index_0) == 0x000000, "Member 'UMG_RadialMenu_C_GetChild::Index_0' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_GetCurrentIndex, Index_0) == 0x000000, "Member 'UMG_RadialMenu_C_GetCurrentIndex::Index_0' has a wrong offset!");
...
static_assert(sizeof(UMG_RadialMenu_C_GetSelectedWidget) == 0x000020, "Wrong size on UMG_RadialMenu_C_GetSelectedWidget");
...
static_assert(offsetof(UMG_RadialMenu_C_GetSelectedWidget, CallFunc_Array_Length_ReturnValue) == 0x000008, "Member 'UMG_RadialMenu_C_GetSelectedWidget::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_GetSelectedWidget, CallFunc_Array_Get_Item) == 0x000010, "Member 'UMG_RadialMenu_C_GetSelectedWidget::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_GetSelectedWidget, CallFunc_Less_IntInt_ReturnValue) == 0x000018, "Member 'UMG_RadialMenu_C_GetSelectedWidget::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
// Function UMG_RadialMenu.UMG_RadialMenu_C.IsJoystickBeingUsed
// 0x0028 (0x0028 - 0x0000)
struct UMG_RadialMenu_C_IsJoystickBeingUsed final
{
public:
	struct FVector2D                              LookStickValue1;                                   // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              LookStickValue;                                    // 0x0010(0x0010)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          JoystickIsBeingUsed;                               // 0x0020(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_Vector2DVector2D_ReturnValue;  // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_EqualEqual_Vector2DVector2D_ErrorTolerance_ImplicitCast; // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(UMG_RadialMenu_C_IsJoystickBeingUsed) == 0x000008, "Wrong alignment on UMG_RadialMenu_C_IsJoystickBeingUsed");
static_assert(sizeof(UMG_RadialMenu_C_IsJoystickBeingUsed) == 0x000028, "Wrong size on UMG_RadialMenu_C_IsJoystickBeingUsed");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, LookStickValue1) == 0x000000, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::LookStickValue1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, LookStickValue) == 0x000010, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::LookStickValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, JoystickIsBeingUsed) == 0x000020, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::JoystickIsBeingUsed' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, CallFunc_EqualEqual_Vector2DVector2D_ReturnValue) == 0x000021, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::CallFunc_EqualEqual_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, CallFunc_Not_PreBool_ReturnValue) == 0x000022, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_IsJoystickBeingUsed, CallFunc_EqualEqual_Vector2DVector2D_ErrorTolerance_ImplicitCast) == 0x000024, "Member 'UMG_RadialMenu_C_IsJoystickBeingUsed::CallFunc_EqualEqual_Vector2DVector2D_ErrorTolerance_ImplicitCast' has a wrong offset!");
...
public:
	...
	class UUserWidget*                            CallFunc_GetSelectedWidget_Output_1;               // 0x0030(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_NotEqual_IntInt_ReturnValue_2;            // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, Index_0) == 0x000000, "Member 'UMG_RadialMenu_C_SetIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000008, "Member 'UMG_RadialMenu_C_SetIndex::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, CallFunc_NotEqual_IntInt_ReturnValue_1) == 0x000009, "Member 'UMG_RadialMenu_C_SetIndex::CallFunc_NotEqual_IntInt_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, K2Node_DynamicCast_AsIRadial_Slot) == 0x000018, "Member 'UMG_RadialMenu_C_SetIndex::K2Node_DynamicCast_AsIRadial_Slot' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'UMG_RadialMenu_C_SetIndex::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, CallFunc_GetSelectedWidget_Output_1) == 0x000030, "Member 'UMG_RadialMenu_C_SetIndex::CallFunc_GetSelectedWidget_Output_1' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, CallFunc_IsValid_ReturnValue) == 0x000049, "Member 'UMG_RadialMenu_C_SetIndex::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_SetIndex, CallFunc_NotEqual_IntInt_ReturnValue_2) == 0x00004A, "Member 'UMG_RadialMenu_C_SetIndex::CallFunc_NotEqual_IntInt_ReturnValue_2' has a wrong offset!");
...
// Function UMG_RadialMenu.UMG_RadialMenu_C.Update Direction With Joystick
// 0x0058 (0x0058 - 0x0000)
struct UMG_RadialMenu_C_Update_Direction_With_Joystick final
{
public:
	...
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerControllerJP_TutorialBP_C*       K2Node_DynamicCast_AsPlayer_Controller_JP_Tutorial_BP; // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_IsJoystickBeingUsed_LookStickValue;       // 0x0028(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed;  // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              CallFunc_IsJoystickBeingUsed_LookStickValue_1;     // 0x0040(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed_1; // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(UMG_RadialMenu_C_Update_Direction_With_Joystick) == 0x000008, "Wrong alignment on UMG_RadialMenu_C_Update_Direction_With_Joystick");
static_assert(sizeof(UMG_RadialMenu_C_Update_Direction_With_Joystick) == 0x000058, "Wrong size on UMG_RadialMenu_C_Update_Direction_With_Joystick");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, CallFunc_GetOwningPlayer_ReturnValue) == 0x000000, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, K2Node_DynamicCast_AsPlayer_Controller_JP_Match_BP) == 0x000008, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::K2Node_DynamicCast_AsPlayer_Controller_JP_Match_BP' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, K2Node_DynamicCast_AsPlayer_Controller_JP_Tutorial_BP) == 0x000018, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::K2Node_DynamicCast_AsPlayer_Controller_JP_Tutorial_BP' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, K2Node_DynamicCast_bSuccess_1) == 0x000020, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, CallFunc_IsJoystickBeingUsed_LookStickValue) == 0x000028, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::CallFunc_IsJoystickBeingUsed_LookStickValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed) == 0x000038, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, CallFunc_IsJoystickBeingUsed_LookStickValue_1) == 0x000040, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::CallFunc_IsJoystickBeingUsed_LookStickValue_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_Update_Direction_With_Joystick, CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed_1) == 0x000050, "Member 'UMG_RadialMenu_C_Update_Direction_With_Joystick::CallFunc_IsJoystickBeingUsed_JoystickIsBeingUsed_1' has a wrong offset!");
...
static_assert(offsetof(UMG_RadialMenu_C_UpdateChildPosition, Index_0) == 0x000000, "Member 'UMG_RadialMenu_C_UpdateChildPosition::Index_0' has a wrong offset!");
...
public:
	...
	double                                        CallFunc_MultiplyMultiply_FloatFloat_Base_ImplicitCast; // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor) == 0x0000F0, "Wrong size on UMG_RadialMenu_C_UpdateDirectionWithMouseCursor");
...
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_GetViewportSize_ReturnValue) == 0x000008, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_GetViewportSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue) == 0x000018, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_BreakVector2D_X) == 0x000020, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_BreakVector2D_Y) == 0x000028, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000030, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000038, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_GetViewportScale_ReturnValue_1) == 0x000040, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_GetViewportScale_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_MakeVector2D_ReturnValue) == 0x000048, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000058, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000060, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_MakeVector2D_ReturnValue_1) == 0x000068, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_MakeVector2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_GetMousePositionOnViewport_ReturnValue) == 0x000078, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_GetMousePositionOnViewport_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_Vector2DVector2D_ReturnValue) == 0x000088, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Subtract_Vector2DVector2D_ReturnValue) == 0x000098, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Subtract_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Normal2D_ReturnValue) == 0x0000A8, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Normal2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Multiply_Vector2DVector2D_ReturnValue) == 0x0000B8, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Multiply_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_VSize2D_ReturnValue) == 0x0000C8, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_VSize2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x0000D0, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_MultiplyMultiply_FloatFloat_Base_ImplicitCast) == 0x0000D8, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_MultiplyMultiply_FloatFloat_Base_ImplicitCast' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_DoubleDouble_B_ImplicitCast) == 0x0000E0, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(UMG_RadialMenu_C_UpdateDirectionWithMouseCursor, CallFunc_Divide_DoubleDouble_B_ImplicitCast_1) == 0x0000E8, "Member 'UMG_RadialMenu_C_UpdateDirectionWithMouseCursor::CallFunc_Divide_DoubleDouble_B_ImplicitCast_1' has a wrong offset!");
