...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08D6A070;
	constexpr int32 AppendString      = 0x010AE5B0;
	constexpr int32 GNames            = 0x08CB32C0;
	constexpr int32 GWorld            = 0x08EEA1C8;
	constexpr int32 ProcessEvent      = 0x0129A3E0;
